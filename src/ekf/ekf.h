...
typedef void (*StateTransitionFunc)(arm_matrix_instance_f32 *x_in, arm_matrix_instance_f32 *u, arm_matrix_instance_f32 *x_out);
typedef void (*ObservationFunc)(arm_matrix_instance_f32 *x, arm_matrix_instance_f32 *h_out);
